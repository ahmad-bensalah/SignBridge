...
| 2 | **STT Workspace** | `pages/2_STT_Vosk.py` | Upload or record audio for instant transcription using Whisper-small. |
...
├── pages/
│   ├── 2_STT_Vosk.py           # Speech-to-Text page
...
> [!NOTE]
> Make sure the trained models from the **STT**, **TTS**, and **SiTT** notebooks have been exported and placed in the expected paths before launching the demo. See the [main README](../README.md) for full setup instructions.
